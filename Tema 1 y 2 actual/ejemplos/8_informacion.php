        ...
        <div class="segunda_caja">
            ...
            <div class="primera_columna">
                <ul>
                    ...
                    <li><a href="7_vocales.php">Vovales</a></li>
                    <li><a href="8_informacion.php">Informacion</a></li>
                    <li><a href="9_tryCatch.php">Try Catch</a></li>
                </ul>
            </div>
            <div class="segunda_columna">
                <p>
                    <?php
                       phpinfo($what = INFO_VARIABLES);
                    ?>
                </p>
            </div>
            <div class="tercer_columna">asssa</div>
        </div>
